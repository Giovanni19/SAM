...
// Valore canonico dell'ultima voce della lista atenei. È quello che finisce
// su Supabase, quindi resta in italiano: l'etichetta tradotta sta nel
// dizionario (t.universityOther).
export const UNIVERSITY_OTHER = "Altro";
